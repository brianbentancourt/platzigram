			...
			<div class="row">
			  <div class="signup-box">
				...
				<form class="signup-form">
				  <div class="section">
					<a class="btn btn-fb hide-on-small-only"><i class="fa fa-facebook-official"></i> ${translate.message('signup.facebook')}</a>
				  </div>
				  <div class="divider"></div>
				  <div class="section"><input type="text" name="username" placeholder="${translate.message('username')}" />
